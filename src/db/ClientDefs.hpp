...
struct AchievementRec {
	...
	uint32_t m_Title_lang_bitmask;	const char* m_Description_lang[16];
	uint32_t m_Description_lang_bitmask;	int32_t m_Category;
	int32_t m_Points;
	int32_t m_Ui_order;
	int32_t m_Flags;
	int32_t m_IconID;
	const char* m_Reward_lang[16];
	uint32_t m_Reward_lang_bitmask;	int32_t m_Minimum_criteria;
...
struct Achievement_CategoryRec {
	...
	uint32_t m_Name_lang_bitmask;	int32_t m_Ui_order;
...
struct Achievement_CriteriaRec {
	...
	uint32_t m_Description_lang_bitmask;	int32_t m_Flags;
...
struct AreaPOIRec {
	...
	int32_t m_AreaID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_Description_lang[16];
	uint32_t m_Description_lang_bitmask;	int32_t m_WorldStateID;
...
struct AreaTableRec {
	...
	uint32_t m_AreaName_lang_bitmask;	int32_t m_FactionGroupMask;
...
struct BarberShopStyleRec {
	...
	uint32_t m_DisplayName_lang_bitmask;	const char* m_Description_lang[16];
	uint32_t m_Description_lang_bitmask;	float m_Cost_Modifier;
	int32_t m_Race;
	int32_t m_Sex;
	int32_t m_Data;
...
struct BattlemasterListRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_MaxGroupSize;
...
struct CharTitlesRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_Name1_lang[16];
	uint32_t m_Name1_lang_bitmask;	int32_t m_Mask_ID;
...
struct ChatChannelsRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_Shortcut_lang[16];
...
struct ChrClassesRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_Name_female_lang[16];
	uint32_t m_Name_female_lang_bitmask;	const char* m_Name_male_lang[16];
	uint32_t m_Name_male_lang_bitmask;	const char* m_Filename;
...
struct ChrRacesRec {
	...
	uint32_t m_Name_lang_bitmask;	const char* m_Name_female_lang[16];
	uint32_t m_Name_female_lang_bitmask;	const char* m_Name_male_lang[16];
	uint32_t m_Name_male_lang_bitmask;	const char* m_FacialHairCustomization[2];
...
struct CreatureFamilyRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_IconFile;
...
struct CreatureTypeRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_Flags;
...
struct DanceMovesRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_LockID;
...
struct DungeonEncounterRec {
	...
	int32_t m_Bit;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_SpellIconID;
...
struct ExhaustionRec {
	...
	float m_InnHours;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	float m_Threshold;
...
struct ItemLimitCategoryRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_Quantity;
	int32_t m_Flags;
...
struct ItemRandomSuffixRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_InternalName;
	int32_t m_Enchantment[5];
...
struct ItemSetRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_ItemID[17];
...
struct ItemSubClassRec {
	...
	const char* m_DisplayName_lang[16];
	uint32_t m_DisplayName_lang_bitmask;	const char* m_VerboseName_lang[16];
...
struct LFGDungeonGroupRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_Order_index;
...
struct LFGDungeonsRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_MinLevel;
	int32_t m_MaxLevel;
...
struct LockTypeRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_ResourceName_lang[16];
	uint32_t m_ResourceName_lang_bitmask;	const char* m_Verb_lang[16];
	uint32_t m_Verb_lang_bitmask;	const char* m_CursorName;
...
struct MailTemplateRec {
	...
	uint32_t m_Subject_lang_bitmask;	const char* m_Body_lang[16];
...
struct MapRec {
	...
	uint32_t m_MapName_lang_bitmask;	int32_t m_AreaTableID;
	const char* m_MapDescription0_lang[16];
	uint32_t m_MapDescription0_lang_bitmask;	const char* m_MapDescription1_lang[16];
	uint32_t m_MapDescription1_lang_bitmask;	int32_t m_LoadingScreenID;
...
struct MapDifficultyRec {
	...
	uint32_t m_Message_lang_bitmask;	int32_t m_RaidDuration;
	int32_t m_MaxPlayers;
...
struct PetPersonalityRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_HappinessThreshold[3];
...
struct ResearchBranchRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_ResearchFieldID;
...
struct SkillLineRec {
	...
	const char* m_DisplayName_lang[16];
	uint32_t m_DisplayName_lang_bitmask;	const char* m_Description_lang[16];
	uint32_t m_Description_lang_bitmask;	int32_t m_SpellIconID;
	const char* m_AlternateVerb_lang[16];
	uint32_t m_AlternateVerb_lang_bitmask;	int32_t m_CanLink;
...
struct SkillLineCategoryRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_SortIndex;
...
struct SpellRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	const char* m_NameSubtext_lang[16];
	uint32_t m_NameSubtext_lang_bitmask;	const char* m_Description_lang[16];
	uint32_t m_Description_lang_bitmask;	const char* m_AuraDescription_lang[16];
	uint32_t m_AuraDescription_lang_bitmask;	int32_t m_ManaCostPct;
...
struct SpellDispelTypeRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_Mask;
...
struct SpellItemEnchantmentRec {
	...
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_ItemVisual;
	int32_t m_Flags;
...
struct SpellRangeRec {
	...
	int32_t m_Flags;
	const char* m_DisplayName_lang[16];
	uint32_t m_DisplayName_lang_bitmask;	const char* m_DisplayNameShort_lang[16];
...
struct TaxiNodesRec {
	...
	float m_Pos[3];
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_MountCreatureID[2];
...
struct TotemCategoryRec {
	...
	int32_t m_ID;
	const char* m_Name_lang[16];
	uint32_t m_Name_lang_bitmask;	int32_t m_TotemCategoryType;
...
struct WorldStateUIRec {
	...
	uint32_t m_String_lang_bitmask;	const char* m_Tooltip_lang[16];
	uint32_t m_Tooltip_lang_bitmask;	int32_t m_StateVariable;
	int32_t m_Type;
	const char* m_DynamicIcon;
	const char* m_DynamicTooltip_lang[16];
	uint32_t m_DynamicTooltip_lang_bitmask;	const char* m_ExtendedUI;
