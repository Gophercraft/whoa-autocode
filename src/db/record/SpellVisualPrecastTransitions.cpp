...
bool SpellVisualPrecastTransitionsRec::Read(SFile* f, const char* stringBuffer) {
	...
	if (
		...
		SFile::Read(f, &m_PrecastLoadAnimName_bitmask, sizeof(uint32_t), nullptr, nullptr, nullptr) == 0 ||
		SFile::Read(f, &m_PrecastHoldAnimName_bitmask, sizeof(uint32_t), nullptr, nullptr, nullptr) == 0
	)
	{
