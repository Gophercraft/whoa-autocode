...
uint32_t ItemDamageOneHandCasterRec::GetNumColumns() {
    return 9;
}

uint32_t ItemDamageOneHandCasterRec::GetRowSize() {
    return 36;
}

bool ItemDamageOneHandCasterRec::NeedIDAssigned() {
    return false;
}
...
void ItemDamageOneHandCasterRec::SetID(int32_t id) {
    this->m_ID = id;
}
