...
uint32_t LFGDungeonGroupRec::GetNumColumns() {
    return 21;
}

uint32_t LFGDungeonGroupRec::GetRowSize() {
    return 84;
}
...
bool LFGDungeonGroupRec::Read(SFile* f, const char* stringBuffer) {
    ...
    if (
        ...
        || !SFile::Read(f, &this->m_parentGroupID, sizeof(this->m_parentGroupID), nullptr, nullptr, nullptr)
